...
moduleForModel('i-i-s-kachestvo-vody-v-rodnikakh-permskogo-kraya-user', 'Unit | Serializer | i-i-s-kachestvo-vody-v-rodnikakh-permskogo-kraya-user', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-kachestvo-vody-v-rodnikakh-permskogo-kraya-user',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
