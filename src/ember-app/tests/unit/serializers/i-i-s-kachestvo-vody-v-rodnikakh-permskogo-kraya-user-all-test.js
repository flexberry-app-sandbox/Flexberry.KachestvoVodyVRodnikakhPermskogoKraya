...
moduleForModel('i-i-s-kachestvo-vody-v-rodnikakh-permskogo-kraya-user-all', 'Unit | Serializer | i-i-s-kachestvo-vody-v-rodnikakh-permskogo-kraya-user-all', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-kachestvo-vody-v-rodnikakh-permskogo-kraya-user-all',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
