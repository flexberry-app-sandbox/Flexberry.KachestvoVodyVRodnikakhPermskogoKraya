...
moduleForModel('i-i-s-kachestvo-vody-v-rodnikakh-permskogo-kraya-photo', 'Unit | Serializer | i-i-s-kachestvo-vody-v-rodnikakh-permskogo-kraya-photo', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-kachestvo-vody-v-rodnikakh-permskogo-kraya-photo',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
