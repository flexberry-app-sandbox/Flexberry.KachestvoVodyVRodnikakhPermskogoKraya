...
moduleForModel('i-i-s-kachestvo-vody-v-rodnikakh-permskogo-kraya-check-file', 'Unit | Serializer | i-i-s-kachestvo-vody-v-rodnikakh-permskogo-kraya-check-file', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-kachestvo-vody-v-rodnikakh-permskogo-kraya-check-file',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
