...
moduleForModel('i-i-s-kachestvo-vody-v-rodnikakh-permskogo-kraya-comment', 'Unit | Serializer | i-i-s-kachestvo-vody-v-rodnikakh-permskogo-kraya-comment', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-kachestvo-vody-v-rodnikakh-permskogo-kraya-comment',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
