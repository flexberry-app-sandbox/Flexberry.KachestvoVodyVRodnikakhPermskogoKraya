...
moduleForModel('i-i-s-kachestvo-vody-v-rodnikakh-permskogo-kraya-spring', 'Unit | Serializer | i-i-s-kachestvo-vody-v-rodnikakh-permskogo-kraya-spring', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-kachestvo-vody-v-rodnikakh-permskogo-kraya-spring',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
